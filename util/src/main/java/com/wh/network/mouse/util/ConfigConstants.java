...
public class ConfigConstants {
    ...
    public static final String KEYSTORE_CONFIG_KEY = "keystore_config_file_path";
    ...
    public static final String KEYSTORE_DEFAULT_CONFIG_FILE_NAME = "network-mouse.jks";
